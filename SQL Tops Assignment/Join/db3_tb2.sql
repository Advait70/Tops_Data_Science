...
CREATE TABLE `tb2` (
  `tb2_id` int NOT NULL,
  `tb2_marks` int NOT NULL,
  `tb2_percentage` int NOT NULL,
  PRIMARY KEY (`tb2_id`),
  CONSTRAINT `tb_id` FOREIGN KEY (`tb2_id`) REFERENCES `tb1` (`tb1_id`)
...
INSERT INTO `tb2` VALUES (1,50,60),(2,65,70),(3,80,88),(4,90,95);
